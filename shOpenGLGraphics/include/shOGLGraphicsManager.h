...
#include "shOGLDevice.h"
#include "shOGLFrameBuffer.h"
...
class OGLGraphicsManager : public GraphicsManager
{
  ...
  */
  ...
  internalCreateProgramShader(const String& vertexFileName,
 ...
 private:
  ...
  SPtr<OGLRenderContext> m_rContext;

  SPtr<OGLFrameBuffer> m_framebuffer;

  SPtr<OGLDepthRender> m_depthRender;
};
}