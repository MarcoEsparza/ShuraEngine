...
void
HBlurCS(uint3 gID : SV_GroupID,
         uint3 dtID : SV_DispatchThreadID,
         uint3 gtID : SV_GroupThreadID,
         uint GI : SV_GroupIndex)
{
  // Gaussian weights for a 9-tap kernel with sigma = 2.0
